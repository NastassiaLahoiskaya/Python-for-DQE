...
from classes.db_handler import DatabaseHandler
...
def main():
    ...
    while True:
        ...
        if flag == '1':
            ...
            db_handler.insert_advertising(advng)
        elif flag == '3':
            ...
            db_handler.insert_quiz(question)
        elif flag == '4':
            ...
            file_handler.write_to_database()
...
DatabaseHandler().selecting_all_tables()
